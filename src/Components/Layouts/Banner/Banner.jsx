    ...
    return (
        <div className="banner ">
            <div className="relative grid h-[28rem] w-full max-w-full flex-col items-end justify-center overflow-hidden rounded bg-white bg-clip-border text-center text-gray-700">
                ...
                >
                    <div className="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-t from-[#151515] to-[rgba(21, 21, 21, 0)]"></div>
                </div>
                <div className="relative my-auto md:px-12 ">
                    <h5 className="block font-sans text-4xl antialiased font-semibold leading-snug tracking-tight text-gray-300">
                        Find Your Dream Job
                    </h5>
                    <p className="text-white text-lg">Your next adventure awaits. Search jobs & launch your career.</p>
                    <form
