...
const JobCategory = () => {
  ...
  return (
    <div>
          <Marquee className="text-4xl font-extrabold mb-8 text-center text-white bg-gradient-to-r from-purple-500 to-pink-500 p-4 rounded-lg shadow-md animate__animated animate__fadeIn mt-5">
              <h2>
